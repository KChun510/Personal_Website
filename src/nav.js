...
const NavBar = () =>{
    return(
        <ul className = "nav">
            <li id = 'coffee_logo'>
            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fillRule="currentColor" className="bi bi-cup-hot-fill"
                viewBox="0 0 16 16">
            ...
            <li id = 'paired_logos-git' className='hidden-mobile'>
                <a href="https://github.com/KChun510" className="btn" role="button" target="_blank" rel="noopener noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fillRule="currentColor" className="bi bi-github"
                    viewBox="0 0 16 16">
                    <path
            ...
            <li id = 'paired_logos-mail' className='hidden-mobile'>
                <button type="button" className="btn  dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
        <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fillRule="currentColor" className="bi bi-envelope-fill"
          viewBox="0 0 16 16">
          <path
      ...
      <ul className="dropdown-menu dropdown-menu-end bg-transparent border-0">
        <li><button id='dropdowns' className="dropdown-item bg-transparent"> <b>Email:</b> kchun1080@gmail.com </button></li>
        <li><button   id='dropdowns' className="dropdown-item bg-transparent"> <b> Number:</b> 669-240-8751</button></li>
        <a href="https://docs.google.com/document/d/1hntd_5oO9LEG1VROp7yyMDBYjHeteKE67jbvkK7YihU/edit?usp=sharing"
          ...
          <li><button  id='dropdowns' className="dropdown-item bg-transparent" type="button"> <b>Full resume </b> </button></li>
        </a>
      </ul>
